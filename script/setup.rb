...
LAB_ROOT_URL = {
  :default     => config_lab_root_url[:default]     || "//lab-framework.concord.org/version/1.4.0/lab",
  :production  => config_lab_root_url[:production]  || "//lab-framework.concord.org/version/1.4.0/lab",
  :staging     => config_lab_root_url[:staging]     || "//lab-framework.concord.org/version/1.5.0-pre.1/lab",

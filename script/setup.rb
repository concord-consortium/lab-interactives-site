...
LAB_ROOT_URL = {
  :default     => config_lab_root_url[:default]     || "//lab-framework.concord.org/version/1.16.2/lab",
  :production  => config_lab_root_url[:production]  || "//lab-framework.concord.org/version/1.16.2/lab",
  :staging     => config_lab_root_url[:staging]     || "//lab-framework.concord.org/version/1.16.2/lab",

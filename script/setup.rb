...
LAB_ROOT_URL = {
  :default     => config_lab_root_url[:default]     || "//lab-framework.concord.org/version/1.1.3/lab",
  :production  => config_lab_root_url[:production]  || "//lab-framework.concord.org/version/1.1.3/lab",
  :staging     => config_lab_root_url[:staging]     || "//lab-framework.concord.org/version/1.2.0-pre.3/lab",

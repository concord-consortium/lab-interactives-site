...
LAB_ROOT_URL = {
  :default     => config_lab_root_url[:default]     || "//lab-framework.concord.org/version/1.8.0/lab",
  :production  => config_lab_root_url[:production]  || "//lab-framework.concord.org/version/1.8.0/lab",
  :staging     => config_lab_root_url[:staging]     || "//lab-framework.concord.org/version/1.9.0-pre.4/lab",

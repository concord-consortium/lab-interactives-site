// NOTE: This file was copied out Lab and slightly modified inorder to dermine the actual
// value of some constants like PLANKS_CONSTANT
...
*/
export const ratio = function(from, to) {
...
*/
export const convert = function(val, fromTo) {

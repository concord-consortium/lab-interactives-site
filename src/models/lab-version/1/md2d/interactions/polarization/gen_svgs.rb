...
323.times do |i|
  ...
  vals[:grad_offset] += (11.3/323)
  vals[:left][:val] += dv
  vals[:left][:rx] += (46.0/323)
  vals[:left][:ry] += (11.0/323)
  vals[:left][:c] += 0.117647
  vals[:right][:rx] += (27.5/323)
  vals[:right][:ry] -= (7.5/323)
  vals[:right][:c] -= 0.117647
  vals[:bg][:w] += 605.0/323
...
323.times do |i|
  vals[:grad_offset] += (11.3/323)
  vals[:right][:val] -= dv
  vals[:right][:rx] -= (46.0/323)
  vals[:right][:ry] -= (11.0/323)
  vals[:right][:c] += 0.117647
  vals[:left][:rx] -= (27.5/323)
  vals[:left][:ry] += (7.5/323)
  vals[:left][:c] -= 0.117647
  vals[:bg][:w] -= 605.0/323

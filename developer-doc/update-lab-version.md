...
You should add a tag in this repository to indicate the state of the interactives when they were tested with this version of the lab framework. These tags have the form: lab-x.y.z
